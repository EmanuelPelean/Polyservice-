												...
												<link rel="mask-icon" href="resources/favicon/safari-pinned-tab.svg" color="#5bbad5">
													<meta name="msapplication-TileColor" content="#da532c">
														<meta name="theme-color" content="#ffffff">
															<title>Polyservice Driving School</title>
															...
															<link href="resources/css/bootstrap.min.css" rel="stylesheet">
																...
																<link href="resources/css/animate.css" rel="stylesheet">
																	...
																	<link href="resources/css/modern-business.css" rel="stylesheet">
																		...
																		<script async="async" defer="defer" src="https://maps.googleapis.com/maps/api/js?key=${google_key}"></script>
																			...
																			<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
																				<div class="container">
																					<a class="navbar-brand" href="#">
																						<img src="resources/img/logo.png" width="50" height="50" alt=""></a>
																						...
																						<div class="collapse navbar-collapse" id="navbarResponsive">
																							<ul class="navbar-nav ml-auto">
																								...
																								<li id="loginLi" class="nav-item dropdown">
																									...
																									<ul class="dropdown-menu dropdown-menu-right dropdown-lr" role="menu">
																										<div class="col-lg-12">
																											<div class="text-center"></div>
																											<form id="ajax-login-form" action="#" role="form" autocomplete="off">
																												<div class="form-group">
																													<label for="username">Username:</label>
																													<input type="text" name="username" id="username" tabindex="1" class="form-control" value="" autocomplete="on"></div>

																													<div class="form-group">
																														<label for="password">Password:</label>
																														<input type="password" name="password" id="password" tabindex="2" class="form-control" autocomplete="off"></div>

																														<div class="form-group">
																															<div class="row ">
																																<div class="col-lg-12">
																																	<div class="text-center">
																																		<button id="btnLogin" type="button" class="btn btn-primary btn-md">Sign In</button>
																																	</div>
																																</div>
																															</div>
																														</div>
																																...
																																<div class="row">
																																	<div class="col-lg-12">
																																		<div class="text-center">
																																			...
																																			<a id="btnSignUp" href="registration" class="forgot-password">Click here to register!</a>
																																		</div>
																																	</div>
																																</div>
																															</div>
																							...
																							<div class="container">
																								...
																								<div class="row">
																									...
																									<div class="col-lg-3 mb-3">
																										<div class="card h-100">
																											<h4 class="card-header">CDL A Training</h4>
																											<div class="card-body">
																												<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque.</p>
																											</div>
																											<div class="card-footer">
																									...
																									<div class="col-lg-3 mb-3">
																										<div class="card h-100">
																											<h4 class="card-header">Adult Lessons</h4>
																											<div class="card-body">
																												<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque.</p>
																											</div>
																											<div class="card-footer">
