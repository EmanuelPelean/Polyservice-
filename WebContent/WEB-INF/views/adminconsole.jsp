...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Current Courses"><a class="nav-link" href="#"> <i
						class="fas fa-th-list"></i> <span class="nav-link-text">Courses
							List</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Drives"><a class="nav-link" href="#"> <i
						class="far fa-calendar-alt"></i> <span class="nav-link-text">My
							Drives <br> (Feature coming soon!)
					</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Driving Log"><a class="nav-link" href="#"> <i
						class="far fa-list-alt"></i> <span class="nav-link-text">Driving
							Log<br> (Feature coming soon!)
					</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Message"><a class="nav-link" href="#"> <i
						class="far fa-envelope"></i> <span class="nav-link-text">Contact
							Us <br> (Feature coming soon!)
					</span>
				</a></li>
			</ul>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">Class Records</li>
				<li class="breadcrumb-item">Marketing</li>
			</ol>
			<!-- Current Courses Detail-->
			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-edit"></i> Selected Course Details
				</div>
				<div>
					<div class="card-body">
						<pre id="objectDetail">
					</pre>
						<div class="btn-group btn-group-courses " role="group"
							...
							<button type="button" class="btn btn-danger" data-toggle="modal"
								...
								> Delete Course <i class="far fa-trash-alt"></i>
							</button>
						</div>
					</div>
				</div>
	...
	<!-- Logout Modal-->
		...
		<div class="modal fade" id="deleteCourseModal" tabindex="-1"
			role="dialog" aria-labelledby="deleteCourseModalLabel"
			aria-hidden="true" data-backdrop="false">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="deleteCourseModalLabel">Delete
							course?</h5>
						<button class="close" type="button" data-dismiss="modal"
							aria-label="Close">
							<span aria-hidden="true">×</span>
					...
					<div class="modal-body"><p id="deleteCourseModalLabel" ></p></div>
					<div class="modal-footer">
						<button class="btn btn-secondary" type="button"
							data-dismiss="modal">Cancel</button>
